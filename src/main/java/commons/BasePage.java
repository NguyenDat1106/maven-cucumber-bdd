...
public class BasePage {
    ...
    public String getFirstSelectItemDefaultDropdown(WebDriver driver, String locatorType) {
    	Select select = new Select(getWebElement(driver, locatorType));
    	return select.getFirstSelectedOption().getText();
    }
    
    public String getFirstSelectItemDefaultDropdown(WebDriver driver, String locatorType, String...dynamicValues) {
    	Select select = new Select(getWebElement(driver, getDynamicXpath(locatorType, dynamicValues)));
    	return select.getFirstSelectedOption().getText();
    }
    ...
    public void selectItemCustomDropdown(WebDriver driver, String parentLocator, String childLocator, String textExpectedItem) {
	...
	/*
	* Wait for element undisplayed i DOM or not in DOM and override inplicit timeout
	*/
	...
	public void waitForElementUnVisible(WebDriver driver, String locatorType) {
		WebDriverWait explicitWait = new WebDriverWait(driver, longTimeout);
		explicitWait.until(ExpectedConditions.invisibilityOfElementLocated(getByLocator(locatorType)));
	}
	...
	public UserRewardPointPageObject openRewardPage(WebDriver driver) {
	...
	/**
	 * Select item dropdown by name attribute
	 * @param driver
	...
	public void selectToDropdownByName(WebDriver driver, String dropdownAttributeName, String itemValue) {
		...
		selectItemDefaultDropdown(driver, BasePageNopCommerceUI.DYNAMIC_DROPDOWN_BY_NAME, itemValue, dropdownAttributeName);
	}
	
	/**
	 * Click to dynamic radio button label name
	 * @param driver
	 * @param radioButtonLabelName
	 */
	public void clickRadioButtonByLabel(WebDriver driver, String radioButtonLabelName) {
	...
	/**
	 * Click to dynamic checkbox label name
	 * @param driver
	 * @param ckeckboxLabelName
	 */
	public void clickCheckboxButtonByLabel(WebDriver driver, String ckeckboxLabelName) {
		waitForElementClickable(driver, BasePageNopCommerceUI.DYNAMIC_CHECKBOX_BY_LABEL, ckeckboxLabelName);
		checkToDefaultCheckboxOrRadio(driver, BasePageNopCommerceUI.DYNAMIC_CHECKBOX_BY_LABEL, ckeckboxLabelName);	
	}
